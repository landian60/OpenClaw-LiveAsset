...
import type { AppViewState, LiveAssetPanelState, LiveAssetRuntimeState } from "./app-view-state.ts";
...
export class OpenClawApp extends LitElement {
  ...
  @state() liveAssetPanel: LiveAssetPanelState | null = null;
  @state() liveAssetSavePromptOpen = false;
  @state() liveAssetStartUserInputIndex: number | null = null;
  @state() liveAssetScopeRuntimeState: LiveAssetRuntimeState | null = null;
