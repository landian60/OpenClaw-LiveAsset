...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    assets: "查看可复用的行为资产，以及塑造它们的真实反馈上下文。",
    nodes: "配对设备、功能和命令公开。",
  ...
  assets: {
    title: "LiveAssets",
    subtitle: "展示统一 LiveAssets 的控制规则、可复用产物、评估样例与真实反馈上下文。",
    filter: "筛选",
    filterPlaceholder: "搜索 LiveAssets、控制规则、代码产物、评估样例或反馈文本",
    shown: "显示 {shown} / 共 {total}",
    empty: "网关当前没有可用的 LiveAssets。",
    noMatches: "当前筛选没有匹配的 LiveAssets。",
    catalog: "LiveAssets 目录",
    catalogSubtitle: "按效用排序的 LiveAssets。",
    detail: "LiveAssets 详情",
    emptyDetail: "选择一个 LiveAsset，查看控制规则、代码产物、评估样例和反馈历史。",
    instruction: "指令",
    keywords: "触发关键词",
    trigger: "触发条件",
    regex: "正则",
    contextSignals: "上下文信号",
    controls: "控制规则",
    replyRules: "回复规则",
    processRules: "过程规则",
    requiredChecks: "必做检查",
    ...
    scopeTaskTypes: "任务类型",
    artifacts: "代码产物",
    artifactsSubtitle: "可复用的命令、片段和 patch 类构件。",
    emptyArtifacts: "这个 LiveAsset 还没有定义可复用代码产物。",
    artifactWhen: "使用条件",
    artifactContent: "内容",
    artifactVerify: "验证方式",
    artifactsLabel: "{count} 个产物",
    evalCases: "评估样例",
    evalCasesSubtitle: "挂在这个 LiveAsset 上的最小回归检查。",
    emptyEvalCases: "这个 LiveAsset 还没有评估样例。",
    evalCasesLabel: "{count} 个评估样例",
    evalPrompt: "测试提示",
    ...
    feedbackSubtitle: "基于真实交互上下文、当时输出和期望修正的记录。",
    emptyHistory: "这个 LiveAsset 暂时还没有记录反馈历史。",
    scenario: "观察到的上下文",
    observedOutput: "观察到的输出",
    noObservedOutput: "这个样例没有记录当时输出。",
    preferredHandling: "期望处理方式",
    lastUpdated: "最近更新",
    utilityLabel: "效用 {value}",
    examplesLabel: "{count} 个样例",
    session: "会话",
    channel: "频道",
    agent: "代理",
    accept: "接受",
    ...
    editorSubtitle: "以 JSON 编辑当前选中的 LiveAsset，并通过插件 API 保存回去。",
