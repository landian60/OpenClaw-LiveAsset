...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    assets: "Inspect reusable LiveAssets and the feedback that shaped them.",
  ...
  assets: {
    title: "LiveAssets",
    subtitle:
      "Unified LiveAssets with controls, reusable artifacts, eval cases, and real feedback context.",
    filter: "Filter",
    filterPlaceholder: "Search LiveAssets, controls, artifacts, eval cases, or feedback text",
    shown: "{shown} shown of {total}",
    empty: "No LiveAssets are available from the gateway.",
    noMatches: "No LiveAssets match the current filter.",
    catalog: "LiveAssets Catalog",
    catalogSubtitle: "Utility-ranked LiveAssets loaded from the plugin.",
    detail: "LiveAssets Detail",
    emptyDetail:
      "Select a LiveAsset to inspect controls, artifacts, eval cases, and feedback history.",
    ...
    scopeAgents: "Agents",
    scopeTaskTypes: "Task Types",
    artifacts: "Artifacts",
    artifactsSubtitle: "Reusable commands, snippets, and patch-like building blocks.",
    emptyArtifacts: "No reusable artifacts have been defined for this LiveAsset yet.",
    artifactWhen: "Use When",
    artifactContent: "Content",
    artifactVerify: "Verify",
    artifactsLabel: "{count} artifacts",
    evalCases: "Eval Cases",
    evalCasesSubtitle: "Minimal regression checks attached to this LiveAsset.",
    emptyEvalCases: "No eval cases have been attached to this LiveAsset yet.",
    evalCasesLabel: "{count} eval cases",
    evalPrompt: "Prompt",
    successCriteria: "Success Criteria",
    evalReason: "Last Judge Reason",
    evalPending: "Pending",
    evalPassed: "Passed",
    evalFailed: "Failed",
    ...
    feedbackSubtitle:
      "Actual interaction contexts, observed outputs, and the preferred correction.",
    emptyHistory: "No feedback history has been recorded for this LiveAsset yet.",
    scenario: "Observed Context",
    observedOutput: "Observed Output",
    noObservedOutput: "No output was captured for this example.",
    preferredHandling: "Preferred Handling",
    lastUpdated: "Last Updated",
    utilityLabel: "Utility {value}",
    examplesLabel: "{count} examples",
    session: "Session",
    channel: "Channel",
    agent: "Agent",
    accept: "Accepted",
    ...
    newButton: "New LiveAssets",
    editorTitle: "LiveAssets Editor",
    editorSubtitle: "Edit the selected LiveAsset as JSON and save it back through the plugin API.",
    saveButton: "Save LiveAssets",
    summary: {
      assets: "LiveAssets",
      examples: "Examples",
      utility: "Avg Utility",
