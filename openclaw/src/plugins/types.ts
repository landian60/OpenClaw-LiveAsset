...
export type PluginHookBeforePromptBuildEvent = {
  prompt: string;
  /** Raw user utterance for this turn before prompt augmentation, when available. */
  rawUserInput?: string;
...
// assistant_response hook
export type PluginHookAssistantResponseEvent = {
  runId: string;
  sessionId: string;
  provider: string;
  model: string;
...
export type PluginHookAssistantResponseResult = {
  text?: string;
};
