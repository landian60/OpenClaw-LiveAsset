...
export async function startGatewayServer(
  ...
  // Configure global undici dispatcher with proxy support (EnvHttpProxyAgent).
  // This ensures HTTP(S)_PROXY environment variables are respected for outbound
  // LLM provider requests in gateway mode.
